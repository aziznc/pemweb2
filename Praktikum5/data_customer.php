<?php
require_once '../praktikum5/class_account_bank.php';

$nama = $_POST['nama'];
$no_rekening = $_POST['norek'];
$saldo = $_POST['saldo'];

$akun_baru1 = new AccountBank("C001", "Aziz", 600000);
$akun_baru2 = new AccountBank("C002", "Nur", 500000);
$akun_baru3 = new AccountBank("C003", "Cholis", 1000000);
